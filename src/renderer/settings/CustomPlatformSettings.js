...
import { Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, FormControlLabel, IconButton, Radio, RadioGroup, TextField, } from '@mui/material';
...
export const CustomPlatformSettings = function ({ t, open, setOpenState, editPlatform, }) {
    ...
    const saveCustomPlatform = () => {
        if (editPlatform && settings.customPlatforms[editPlatform.key]) {
            ...
            setSettings('customPlatforms', Object.assign(Object.assign({}, rest), { [customPlatform.key]: customPlatform }));
        }
        else {
            setSettings('customPlatforms', Object.assign(Object.assign({}, settings.customPlatforms), { [customPlatform.key]: customPlatform }));
        }
    };
