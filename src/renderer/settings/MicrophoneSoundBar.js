...
const TestMicrophoneButton = function ({ microphone }) {
    ...
    if (error) {
        return React.createElement(Typography, { color: "error" }, "Could not connect to microphone");
    }
    else {
...
//# sourceMappingURL=MicrophoneSoundBar.js.map