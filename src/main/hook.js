...
ipcMain.handle(IpcHandlerMessages.START_HOOK, async (event) => {
    if (!readingGame) {
        ...
        keyboardWatcher.on('keydown', (keyId) => {
            ...
            if (keyCodeMatches(impostorRadioShortcut, keyId) && ((_b = (_a = gameReader.lastState.players) === null || _a === void 0 ? void 0 : _a.find((value) => { return value.clientId === gameReader.lastState.clientId; })) === null || _b === void 0 ? void 0 : _b.isImpostor)) {
                speaking += 1;
