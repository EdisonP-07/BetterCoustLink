...
export function numberToColorHex(colour) {
    var _a;
    return ('#' +
...
async function colorImages(playerColors, image, imagename) {
...
async function colorImage(img, originalData, color, shadow, savepath, returnImg = false) {
...
export async function GenerateAvatars(colors) {
...
export async function GenerateHat(imagePath, colors, colorId, path) {
    try {
